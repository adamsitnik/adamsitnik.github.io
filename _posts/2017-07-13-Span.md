...
Some people call the 3-field Span "slow Span" and the 2-field "fast Span". BenchmarkDotNet allows running same benchmark for [multiple runtimes](https://adamsitnik.com/Hardware-Counters-Diagnoser/#how-to-get-it-running-for-net-coremono-on-windows). Let's use it and compare the indexer for .NET 4.6, .NET Core 1.1 and .NET Core 2.0.
